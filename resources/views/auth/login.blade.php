                ...
                <div class="card-body">
                    <form action="{{ route('login') }}" method="POST">
                        ...
                        <div class="form-group float-left" >
                            {{-- <input type="submit" value="Login" class="btn confer-btn "><i class="zmdi zmdi-long-arrow-right"></i> --}}
                                {{-- <a href="{{route('profile')}}" class="btn confer-btn  mt-lg-0 pt-1 ml-3 ml-lg-5"><h6 class="pt-2">ورود</h6> <i class="zmdi zmdi-long-arrow-right"></i></a> --}}
