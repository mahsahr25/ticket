...
<div class="container"  style="margin-right:6vh;">
    <div class="row justify-content-center mt-5" style="margin-right:150px;">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        {{-- <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="mobile" type="text" min="11" class="form-control @error('mobile') is-invalid @enderror" name="mobile"   >
                        ...
                        {{-- <div class="form-group row mb-0">
                            ...
                            <div class="form-group float-left " >
                                {{-- <input type="submit" value="Login" class="btn confer-btn "><i class="zmdi zmdi-long-arrow-right"> --}}
                                    {{-- <a href="#" class="btn confer-btn  mt-lg-0 ml-3 ml-lg-5 pt-1"><h6 class="pt-2 ">ثبت نام</h6> <i class="zmdi zmdi-long-arrow-right"></i></a> --}}
                                    <button type="submit" class="btn confer-btn pt-1"><h6 class="pt-2">ورود</h6> <i class="zmdi zmdi-long-arrow-right"></i></button>
                                </div>
                        </div>
                    </form>
                </div>
