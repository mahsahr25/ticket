                ...
                <div class="card-header">
                    ...
                    <div class="card-body">
                      ...
                      <h6 style="direction: rtl; text-align: right; color:rgb(254,254,94); display: inline-block;"> به حساب کاربری خود خوش آمدید!</h6>
                        <div class="pt-20 text-light hovericon " style="padding-top:6vh;direction: rtl; text-align: right;"> <a class="text-light" style="color:black" href="#"><i class="fa fa-ticket" aria-hidden="true"></i>&nbsp;مشاهده  خریدها</a> </div>
