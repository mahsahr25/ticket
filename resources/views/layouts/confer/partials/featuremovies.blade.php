...
<section class="mt-5">
    ...
    @endforeach
        ...
        <div class="col pt-3 hvr-pop" >
            <a href="{{route('single_event')}}">
            <img src="{{asset('assets/img/feature-movies/Poster by Mohammad Hossein Houshmandi.jpg')}}" style="width:100%;height:100%" alt="">
        ...
        <div class="col pt-3 hvr-pop" >
            <a href="{{route('single_event')}}">
            <img src="{{asset('assets/img/feature-movies/jahan.jpg')}}" style="width:100%;height:100%" alt="">
